 ...
 <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/breadcrumbs-bg-print.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <h2>Desain & Percetakan</h2>
        <ol>
          <li><a href="index">Beranda</a></li>
          <li>Desain & Percetakan</li>
        </ol>
    ...
    <section id="constructions" class="constructions">
      <div class="container" data-aos="fade-up">
       ...
       <div class="section-header">
        <h2>Desain & Percetakan</h2>
        <p>Kami menyediakan layanan desain grafis dan percetakan untuk berbagai kebutuhan, mulai dari brosur, spanduk, undangan, hingga branding usaha. Desain kreatif dan hasil cetak berkualitas adalah komitmen kami untuk setiap klien.</p>
      </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-5">
                  <div class="card-bg" style="background-image: url(assets/img/constructions-21.jpg);"></div>
                </div>
                <div class="col-xl-7 d-flex align-items-center">
                 <div class="card-body">
                  <h4 class="card-title">Jasa Printing (Spanduk, Banner, Brosur, dll.)</h4>
                  <p>Kami melayani kebutuhan cetak seperti spanduk, banner, brosur, undangan, dan media promosi lainnya. Dengan kualitas cetak terbaik dan pengerjaan cepat, kami siap mendukung promosi dan kebutuhan visual usaha Anda.</p>
                </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-5">
                  <div class="card-bg" style="background-image: url(assets/img/constructions-22.jpg);"></div>
                </div>
                <div class="col-xl-7 d-flex align-items-center">
                 <div class="card-body">
                  <h4 class="card-title">Desain Grafis & Branding</h4>
                  <p>Kami membantu membangun identitas visual brand Anda melalui desain logo, kemasan, media sosial, dan materi promosi lainnya. Desain yang menarik dan konsisten akan memperkuat citra bisnis Anda di mata pelanggan.</p>
                </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-5">
                  <div class="card-bg" style="background-image: url(assets/img/constructions-23.jpg);"></div>
                </div>
                <div class="col-xl-7 d-flex align-items-center">
                  <div class="card-body">
                <h4 class="card-title">Pemasangan Backdrop Acara</h4>
                <p>Kami menyediakan layanan desain dan pemasangan backdrop untuk berbagai acara seperti seminar, pelatihan, pernikahan, hingga event perusahaan. Dikerjakan dengan bahan berkualitas dan hasil yang rapi untuk mendukung kesuksesan acara Anda.</p>
              </div>
